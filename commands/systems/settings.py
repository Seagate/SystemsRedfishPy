...
class CommandHandler(CommandHandlerBase):
    ...
    def display_results(self, redfishConfig):
        ...
        print('(redfish)![setting] [value] - Change [setting] to the new [value]. For example, !mcip 10.1.2.3 to update the IP address of the Redfish Service.')
        print('')
        print('To begin using this client, you must update these settings:')
        print('')
        print('(redfish)!mcip [value]      - Update the IP address of the Redfish Service.')
