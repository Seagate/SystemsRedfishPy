...
# ******************************************************************************************
#
# TestStorageGroup.py - Unit test cases for Redfish/Swordfish StorageGroup capabilities. 
#
# ******************************************************************************************
#
...
class TestStorageGroup(unittest.TestCase):
    ...
    def test_create_storagegrpoup_1(self):
        ...
        ports = RedfishSystem.get_ports(self.redfishConfig)
        initiators = RedfishSystem.get_initiators(self.redfishConfig)

        TestSupport.create_storage_group(self, self.redfishConfig, '100', 'TestVolume01', 'read-write', ports, initiators)
